...
class ComparisonOverlay(QDialog):
    ...
    def setup_ui(self):
        ...
        # Scale animation for window
        self.window_frame.setGraphicsEffect(None) # Reset effect for animation if needed, but better keep shadow
        # Actually QPropertyAnimation on geometry is better
